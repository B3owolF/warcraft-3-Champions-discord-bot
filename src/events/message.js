...
const eventsMessage = (client) => {
    ...
    client.on('message',async (message) => {
        if(message.content.startsWith(prefix + 'profile ') && channelAllowed(message)
        || 
    ...
    client.on('message', (message) => {
        if(message.content.startsWith(prefix + 'vs ') && channelAllowed(message) 
        ||
    ...
    client.on('message', async (message) => {
      if(message.content.startsWith(prefix + 'Ranking ') && channelAllowed(message) 
        || 
    ...
    client.on('message', (message) => {
      if(message.content.startsWith(prefix + 'Matches ') && channelAllowed(message)
      || 
    ...
    client.on('message', (message) => {
      if(message.content.startsWith(prefix + 'help') && channelAllowed(message)
      ||
